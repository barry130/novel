package com.canace.novel.dto.es;
...
public class EsBookDto {
    ...
    public static EsBookDto build(BookInfo bookInfo){
        return EsBookDto.builder()
                ...
                .bookStatus(Integer.valueOf(bookInfo.getBookStatus()))
                .commentCount(bookInfo.getCommentCount())
                .isVip(Integer.valueOf(bookInfo.getIsVip()))
                .score(Integer.valueOf(bookInfo.getScore()))
                .visitCount(bookInfo.getVisitCount())
                .wordCount(bookInfo.getWordCount())
                .workDirection(Integer.valueOf(bookInfo.getWorkDirection()))
