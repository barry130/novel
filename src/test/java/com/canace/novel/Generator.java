 ...
 * @version 1.0
 * @description 代码生成器
 * @date 2024/1/15 17:50
 */
public class Generator {

    private static final String USERNAME = "canace";
    ...
    private static final String BASE_PACKAGE = "com.canace.novel";

    /**
     * 数据库信息
     */
    private static final String DATABASE_IP = "192.168.31.51";
    ...
    private static void genCode() {
        ...
        FastAutoGenerator.create(String.format("jdbc:mysql://%s:%s/%s?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=Asia/Shanghai", DATABASE_IP, DATABASE_PORT, DATABASE_NAME), DATABASE_USERNAME, DATABASE_PASSWORD)
                ...
                // 策略配置
                .strategyConfig(builder -> builder.addInclude(getTables()) // 设置需要生成的表名
                        .controllerBuilder()
                        .enableRestStyle()
                        .serviceBuilder()
